...
public class MesFPChartView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.MesFPChartView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.MesFPChartView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.MesFPChartView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.MesFPChartView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.MesFPChartView_exampleDrawable);
